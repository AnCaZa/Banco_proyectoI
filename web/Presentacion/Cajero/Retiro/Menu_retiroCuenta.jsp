...
<html>
  ...
  <%@ include file="/Presentacion/link.jsp" %>
    ...
    <body>
        ...
        <% if (cuenta==null){%>
        <form  action="/Banco_proyectoI/Presentacion/Cajero/Retiro/showcuenta" method="POST">
         ...
         <%if(cuenta!=null){%>
           <form class="form_inicio" action="/Banco_proyectoI/Presentacion/Cajero/Retiro/Add" method="POST">
              <p>Numero cuenta:</p><input  type="text" name="Buttoncuenta" value="<%=cuenta.getNumero()%>" readonly>
               ...
               <p>Monto:</p><input  type="text" name="txtMonto" placeholder="<%=this.placeholder("txtMonto", errores, "Monto") %>" > <br> <br>
